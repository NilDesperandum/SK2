...
public:
    ...
    void setupUi(QWidget *MyWidget)
    {
        ...
        gridLayout->addWidget(fourthBtn, 7, 0, 1, 1, Qt::AlignHCenter);
        ...
        gridLayout->addWidget(firstBtn, 3, 0, 1, 1, Qt::AlignHCenter);
        ...
        gridLayout->addWidget(thirdBtn, 6, 0, 1, 1, Qt::AlignHCenter);
        ...
        gridLayout->addWidget(secondBtn, 4, 0, 1, 1, Qt::AlignHCenter);

        lcdNumber = new QLCDNumber(talkGroup);
